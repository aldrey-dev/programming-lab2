...
function displayGreeting() {
    ...
    if (userName === "") {
        ...
        resultMessage.textContent = "The greeting was displayed successfully.";
    }
}

function showTypedText() {
    typingMessage.textContent = "You are typing: " + nameInput.value;
}
...
function resetPage() {
    ...
    resultMessage.textContent = "Enter your name and select an action.";
